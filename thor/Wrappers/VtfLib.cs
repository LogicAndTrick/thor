...
public sealed class VtfLib
{
    ...
    public delegate bool ReadCloseProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    [return:MarshalAs(UnmanagedType.U1)]
    public delegate bool ReadOpenProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint ReadReadProc([MarshalAs(UnmanagedType.I4)]int lpData, uint uiBytes, [MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint ReadSeekProc(int iOffset, SeekMode eSeekMode, [MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint ReadSizeProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint ReadTellProc([MarshalAs(UnmanagedType.I4)]int pUserData);

    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    [return:MarshalAs(UnmanagedType.U1)]
    public delegate bool WriteCloseProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    [return:MarshalAs(UnmanagedType.U1)]
    public delegate bool WriteOpenProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint WriteWriteProc([MarshalAs(UnmanagedType.I4)]int lpData, uint uiBytes, [MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint WriteSeekProc(int iOffset, SeekMode eSeekMode, [MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint WriteSizeProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    public delegate uint WriteTellProc([MarshalAs(UnmanagedType.I4)]int pUserData);
    #endregion
    ...
    [DllImport("VTFLib.dll", CallingConvention = CallingConvention.Cdecl)]
    [return:MarshalAs(UnmanagedType.U1)]
    public unsafe static extern bool vlImageLoadProc([MarshalAs(UnmanagedType.I4)]int pUserData, [MarshalAs(UnmanagedType.U1)]bool bHeaderOnly);
    ...
    [DllImport("VTFLib.dll", CallingConvention = CallingConvention.Cdecl)]
    [return:MarshalAs(UnmanagedType.U1)]
    public unsafe static extern bool vlImageSaveProc([MarshalAs(UnmanagedType.I4)]int pUserData);
